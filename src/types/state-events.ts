// =============================================================================
// EVENT CONTENT TYPES - ROOM STATE
// =============================================================================

import type { UserId, RoomId, EventId, RoomAlias, MxcUri, ServerName, KeyId, Base64 } from "./identifiers.ts";
...
export type HistoryVisibility = "invited" | "joined" | "shared" | "world_readable";
