...
export interface SearchRequest {
  search_categories: {
    room_events?: {
      ...
      event_context?: { before_limit?: number; after_limit?: number; include_profile?: boolean };
...
export interface SearchResponse {
  search_categories: {
    room_events?: {
      ...
      groups?: Record<string, Record<string, { results: string[]; order: number; next_batch?: string }>>;
      next_batch?: string;
    };
  };
}
...
export interface SearchResult {
  ...
  context?: {
    ...
    events_before: ClientEvent[];
    events_after: ClientEvent[];
    profile_info?: Record<UserId, { displayname?: string; avatar_url?: MxcUri }>;
  };
}
