...
export function signJson(
  ...
  const signatures = (obj["signatures"] ?? {}) as Record<string, Record<string, string>>;
...
export function signEvent(event: PDU, serverName: ServerName, key: SigningKey): PDU {
  ...
  const forSigning: Record<string, unknown> = { ...redacted } as unknown as Record<string, unknown>;
...
export function verifyEventSignature(
  ...
  const forVerifying: Record<string, unknown> = { ...redacted } as unknown as Record<string, unknown>;
